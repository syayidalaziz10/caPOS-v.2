        ...
        <form action="" class="flex w-full">
            <div class="flex w-full gap-4">
                <div class="relative w-2/3">
                    ...
                    <input type="text" name="cari" placeholder="Cari semua produk disini ... " class="w-full py-3.5 text-sm px-14 bg-fill rounded-lg outline-1 outline-primary" required>
                </div>
